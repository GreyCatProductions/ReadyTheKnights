...
export const BuildingType = {
    Base:               "base",
    Windmill:           "windmill",
    WindmillEvolved:    "windmill_evolved",
    WindmillDeco:       "windmill_deco",
    Houses:             "houses",
...
export const BUILDING_DEFS: Record<BuildingType, BuildingDef> =
{
    ...
    [BuildingType.Windmill]:         { category: "resource",  daysToBuild: 3, resourceType: "food", resourcePerWorker: 1,  maxWorkers: 3, evolution: { daysToEvolve: 5, evolvesInto: BuildingType.WindmillEvolved, decorative: BuildingType.WindmillDeco } },
    [BuildingType.WindmillEvolved]:  { category: "resource",  daysToBuild: 0, resourceType: "food", resourcePerWorker: 2,  maxWorkers: 5 },
    [BuildingType.WindmillDeco]:     { category: "decorative", daysToBuild: 0 },
